pub use self::services::event::{
    ...
    EVENT_TITLE_MIN_LEN, Event, EventDescription, EventDescriptionError, NewEventForm, EventId,
...
pub use self::services::user::{
    CreateUserError, FindUserError, NewUserForm, USER_NAME_MAX_LEN, USER_NAME_MIN_LEN, User,
    UserId, UserName, UserNameError, UserServiceCreateRequest, UserServiceCreateResponse,
};
